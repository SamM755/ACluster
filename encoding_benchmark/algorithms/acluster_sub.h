#ifndef ACLUSTER_SUB_H
#define ACLUSTER_SUB_H
...
class AClusterSub {
public:
    explicit AClusterSub(int dimension_group_size = 4) : dimension_group_size_(dimension_group_size) {}
    void set_dimension_group_size(int v) { dimension_group_size_ = (v > 0 ? v : 1); }

    std::string get_name() const { return "AClusterSub"; }
